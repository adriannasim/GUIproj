...
export function Login() {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, { setStatus, setSubmitting }) => {
      ...
      try {
        ...
        setCurrentUser(user)
        setLoading(false)
        setStatus({ type: 'success', message: 'Login successfully!' });
        setTimeout(function () {
        ...
        console.error(error)
        saveAuth(undefined)
        setStatus({ type: 'danger', message: 'The login details are incorrect' });
        setSubmitting(false)
        setLoading(false)
      }
    },
  ...
  return (
    ...
    >
      ...
      <div className='bg-white rounded p-10 mb-4'>
