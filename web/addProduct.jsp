    ...
    <body class="g-sidenav-show bg-gray-100">
        <section class="editStaff">
            ...
            <div class="errorMsg row" style="position:relative;top:-20px;">
                <div class="col-sm">
                    <div id="errorIdDiv" style="color:red;font-size:13pt;"></div>
        ...
        <script>
            ...
            function validateId() {
                ...
                var errorDiv = document.getElementById("errorIdDiv");
                if (!name) {
            ...
            document
                    .getElementById("id")
                    .addEventListener("blur", validateId);
            document
                    .getElementById("name")
