            ...
            <div class="container relative">
                <div class="row g-5 mb-5">
                    <div class="col-lg-4">
                        ...
                        <p class="mb-4">From humble beginnings to our current status as a cornerstone of the art community, we've remained dedicated to curating experiences that resonate. Our arts unfold our gallery's story in vivid detail—each slide a chapter, each artwork a milestone.</p>
                        ...
                        <div class="row links-wrap">
                            <div class="col-6 col-sm-6 col-md-3">
                                <ul class="list-unstyled">
                                    ...
                                    <li><a href="#">Blog</a></li>
                                    <li><a href="mailto:<%=companyEmail%>">Contact us</a></li>
                                </ul>
                            </div>
