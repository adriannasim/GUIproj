...
<%@page import="jpaEntity.*,
        java.util.List,java.util.ArrayList,java.text.SimpleDateFormat,
        java.util.Date,java.text.DecimalFormat"%>

<jsp:include page="/RetrieveOrderDetails" />

<% Custorder order = new Custorder();
    if (request.getAttribute("order") != null) {
        order = (Custorder) request.getAttribute("order");
    } %>
                        ...
                        <div class="card">
                            <div class="card-header pb-0 d-flex flex-column">
                                ...
                                <% } %> <% String statusClass = "";
                                    String status
                                            = order.getStatus();
                                    // Assuming getStatus() returns the status of the order 
                                    ...
                                    <div class="d-flex flex-column">
                                        <p class="mb-2 text-xs">
                                            ...
                                            <span class="text-dark ms-sm-2 font-weight-bold">
                                                ...
                                                <%=order.getPostalcode()%>, <%=order.getState()%>,
                                    ...
                                    <form role="form">
                                        ...
                                        <%                                                    order.getStatus();
                                            ...
                                            if (status.equals("Packaging")) {
                                                ...
                                                nextStatus = "Delivery"; // If
                                                String buttonLabel = "Update To \""
                                                        + nextStatus.substring(0, 1).toUpperCase()
                                                        + nextStatus.substring(1) + "\"";%>
                                        <div class="text-center">
                                            <button
                                                id="update-status-submit-btn"
                                                type="button"
                                                class="btn bg-primary w-100 mt-4 mb-0 text-white"
                                                >
                                                <%=buttonLabel%>
                                            </button>
                                        </div>
                                        <script>
                                            ...
                                            document.getElementById(
                                                ...
                                                xhr.send(
                                                        "nextStatus=" + nextStatus + "&orderId=" + orderId
                                                        );
                                            };
                                        </script>
                                    </form>
